      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-green-600 to-green-800 relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col justify-center items-center p-12 text-white">
          <div className="text-center space-y-6">
            ...
            <h1 className="text-4xl font-bold">Welcome Back to WAgent</h1>
            <p className="text-xl text-green-100">
              Connect all your tools with AI-powered automation through WhatsApp
            </p>
            <div className="flex items-center space-x-4 text-green-100">
              <div className="flex items-center space-x-2">
                ...
                <span>10+ Tool Integrations</span>
              </div>
              <div className="flex items-center space-x-2">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                  <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 bg-gray-50">
        <div className="max-w-md w-full space-y-8">
          ...
          <div className="lg:hidden text-center">
            ...
            <p className="text-gray-600">Sign in to your WAgent account</p>
          </div>
